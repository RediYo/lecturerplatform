...
// 星星打分
    $(function(){
        var options	= {
            ...
            info_format	: function(value) {
                ...
                switch (value) {
                    case 1 :
                        info	= '<div class="info-box">1分&nbsp;很不满意<div>上课效果很差，完全不符合预期！</div></div>';
                        break;
                    case 2 :
                        info	= '<div class="info-box">2分&nbsp;不满意<div>上课效果比较差，不符合预期。</div></div>';
                        break;
                    case 3 :
                        info	= '<div class="info-box">3分&nbsp;一般<div>上课效果一般，一般符合。</div></div>';
                        break;
                    case 4 :
                        info	= '<div class="info-box">4分&nbsp;满意<div>上课效果很棒，符合预期。</div></div>';
                        break;
                    case 5 :
                        info	= '<div class="info-box">5分&nbsp;非常满意<div>上课效果非常棒，棒棒哒！</div></div>';
                        break;
                    default :
                        info = value;
                        break;
    ...
    $("#btn-confirm").click(function () {
        ...
        let contentBoolean = $('#modal-content').val().length > 0;
        if(contentBoolean){
            $("#modal-form").submit();
        }
    });
